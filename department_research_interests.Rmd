...
```{r define-ollama-request-function}
...
```{r augment-data-frame-for-collaboration}
...
```{r augment-data-frame-for-required-skills}
...
# Augment information for individual persons

We first augment the list of interests by (1) possible funders, (2) possible ways to generate impact and (3) possible colleagues who could be approached for desired skills. In each case, we ask the models to rate the likelihood of its answers on a 5 point scale, from * to *****.
...
# Identify possible collaborations also funders

```{r query-collaborations}
if(RECALCULATE_EVERYTHING){
    dat.collaborations <- 
